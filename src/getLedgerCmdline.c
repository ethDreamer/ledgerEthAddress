/*
  ...
  gengetopt -i src/gengetopt/getLedgerAddresses_cmd.ggo -F getLedgerCmdline --include-getopt --output-dir=./src 
...
const char *gengetopt_args_info_purpose = "Displays ETH addresses derived from a given key path";

const char *gengetopt_args_info_usage = "Usage: getLedgerAddresses [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -k, --keypath=STRING  key path in a/b/c format using n' for hardened nodes\n                          (default=`44'/60'/0'')",
  "  -c, --confirm         Confirm addresses on Ledger  (default=off)",
  "  -s, --start=INT       Starting address index to display  (default=`0')",
  "  -a, --addresses=INT   Number of derived addresses to display  (default=`5')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->keypath_given = 0 ;
  args_info->confirm_given = 0 ;
  args_info->start_given = 0 ;
  args_info->addresses_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->keypath_arg = gengetopt_strdup ("44'/60'/0'");
  args_info->keypath_orig = NULL;
  args_info->confirm_flag = 0;
  args_info->start_arg = 0;
  args_info->start_orig = NULL;
  args_info->addresses_arg = 5;
  args_info->addresses_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->keypath_help = gengetopt_args_info_help[2] ;
  args_info->confirm_help = gengetopt_args_info_help[3] ;
  args_info->start_help = gengetopt_args_info_help[4] ;
  args_info->addresses_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->keypath_arg));
  free_string_field (&(args_info->keypath_orig));
  free_string_field (&(args_info->start_orig));
  free_string_field (&(args_info->addresses_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->keypath_given)
    write_into_file(outfile, "keypath", args_info->keypath_orig, 0);
  if (args_info->confirm_given)
    write_into_file(outfile, "confirm", 0, 0 );
  if (args_info->start_given)
    write_into_file(outfile, "start", args_info->start_orig, 0);
  if (args_info->addresses_given)
    write_into_file(outfile, "addresses", args_info->addresses_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVk:cs:a:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* key path in a/b/c format using n' for hardened nodes.  */
        
        
          if (update_arg( (void *)&(args_info->keypath_arg), 
               &(args_info->keypath_orig), &(args_info->keypath_given),
              &(local_args_info.keypath_given), optarg, 0, "44'/60'/0'", ARG_STRING,
          ...
          break;
        case 'c':	/* Confirm addresses on Ledger.  */
        
        
          if (update_arg((void *)&(args_info->confirm_flag), 0, &(args_info->confirm_given),
              &(local_args_info.confirm_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "confirm", 'c',
              additional_error))
            goto failure;
        
          break;
        case 's':	/* Starting address index to display.  */
        
        
          if (update_arg( (void *)&(args_info->start_arg), 
               &(args_info->start_orig), &(args_info->start_given),
              &(local_args_info.start_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "start", 's',
              additional_error))
            goto failure;
          ...
          break;
        case 'a':	/* Number of derived addresses to display.  */
        
        
          if (update_arg( (void *)&(args_info->addresses_arg), 
               &(args_info->addresses_orig), &(args_info->addresses_given),
              &(local_args_info.addresses_given), optarg, 0, "5", ARG_INT,
              check_ambiguity, override, 0, 0,
              "addresses", 'a',
              additional_error))
            goto failure;
